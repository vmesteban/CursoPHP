...
//    cuadro de texto seccion del formulario
    ...
    try {
      $base = new PDO("mysql:host=localhost;dbname=x_pruebas1", "root", "");
...
//       Accedemos el objeto->metodo
      echo '<br>';
      echo "<b> Codigo de Error : " . $ex->getCode() . '</b>';
      echo '<br>';
      echo "<b> Linea de Error : " . $ex->getLine() . '</b>';
      echo '<br>';
      die("<b> Error: " . $ex->getMessage() . '</b>');
    } finally {
      $base = null;
    }
    ?>
