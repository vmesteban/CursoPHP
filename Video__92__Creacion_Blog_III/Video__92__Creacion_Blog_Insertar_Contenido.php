  ...
  <body>
    ...
    if ($_FILES['imagen']['error']) {
      ...
      if ((isset($_FILES['imagen']['name']) && ($_FILES['imagen']['error'] == UPLOAD_ERR_OK))) {
        $destino_de_ruta = "Video__92__imagenes/";
...
//    cambiar el campo por la informacion que viene del formulario 
    ...
    <a href="Video__92__Creacion_Blog_Formulario.php">Añadir nueva entrada</a>

    <a href="Video__92__Creacion_Blog_Mostrar_Blog.php">Ver Mostrar Blog</a>
  </body>
</html>
