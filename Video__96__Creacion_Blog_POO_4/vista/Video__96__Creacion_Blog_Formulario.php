...
<html>
  ...
  <body>
    <h2>Nueva entrada</h2>
    <form action="../controlador/Video__96__Transacciones.php" method="post" enctype="multipart/form-data" name="form1">
      <table>
        <tr>
          <td>Título: 
        ...
        <tr>
          <td colspan="2" align="center">
            <a href="Video__96__Mostrar_Blog.php">Página de visualización del blog</a>
          </td>
        </tr>
      </table>
    </form>
