...
//    Inserta datos 
    $insertar = "INSERT INTO PRODUCTOS (SECCIÓN,`NOMBRE ARTÍCULO`,`PAÍS DE ORIGEN`) VALUES ('AR_x1','RAQUETA BADMINTON','España')";
  ...
  <body>
    ...
    <form name="form1" method="get" action="Video__42__Insertando_registros_en_BBDD_Insert3_Recibir_Datos.php">
      <table>
        <tr>
          <td>Seccion</td>
