...
<html>
  ...
  <body>
    ...
    <table>
      ...
      <td>Zona de Usuarios Registrados - 
        <?php
        echo "<h2> Usuario : " . $_SESSION["usuario"] . " </h2><br><br>";
        ?>
      </td>
    </table>
    <a href="Video__62__Login_Sistema_Registro.php">Volver</a>
    <br>
    <a href="Video__62__Login_Sistema_de_Login_III_Cerrar_Session.php">Cierra Session</a>
  </body>
</html>
