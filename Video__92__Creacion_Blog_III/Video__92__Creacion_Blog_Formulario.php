...
<html>
  ...
  <body>
    <h2>Nueva entrada</h2>
    <form action="Video__92__Creacion_Blog_Insertar_Contenido.php" method="post" enctype="multipart/form-data" name="form1">
      <table>
        <tr>
          <td>Título: 
        ...
        <tr>
          <td colspan="2" align="center">
            <a href="Video__92__Creacion_Blog_Mostrar_Blog.php">Página de visualización del blog</a>
          </td>
        </tr>
      </table>
    </form>
